...
## [심화 테스트 260315_testing case_2] TC-08~10 조치

> **상태**: ✅ 수정 완료
> **근거**: `docs/260315_testing case_2.md` 기준 코드 대조 및 미구현 항목 구현

| TC | 조치 요약 |
|----|----------|
| 8-2 | useAiHint: AbortController + 25초 타임아웃 |
| 8-3 | PostMeetingResult: isGeneratingMinutes 시 beforeunload 리스너 |
| 9-1 | 사전 리스트 truncate/line-clamp, STT API 키워드 50개·80자 제한 |
| 9-2 | 대시보드 프로젝트 삭제 버튼 추가 (ON DELETE SET NULL 활용) |
| 10-2 | TopBar isStartingRecording 연타 방지 |
| 10-3 | AuthProvider storage 이벤트로 다중 탭 로그아웃 동기화 |
